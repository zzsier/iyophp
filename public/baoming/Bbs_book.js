...
$(function() {
    ...
    if (userid) {
        ...
        $("#signBtn").bind("click",
            function() {
                if (Detail_Config.bbsid == 6 && boardid == 2 && bookid == 18793) {
...
var Active = {
    ...
    showSignLayer: function(n, type, taskFlag) {
        ...
        $("#GsignLayer .popbox-btns .btn-blue").click(function() {
            ...
            var url = "/index.php?c=Ajax_Active&a=sign";
            type ? url += "&type=" + type: "";
...
$(function() {
    Active.activeId = parseInt($("#activeId").val())
});
Layer.createSpeSignLayer = function() {
    ...
    var html = ['<div class="popbox" id="GsignLayer" style="width:554px; display:none;">', '<div class="popbox-inner">', '<div class="popbox-head">', '<span class="popbox-close border-radius-s3" onclick="javascript:$(\'#GsignLayer\').hide();">\u5173\u95ed</span>', '<h3><i class="line"></i>\u6211\u8981\u62a5\u540d</h3>', "</div>", '<div class="popbox-main">', '<div class="personal-infor">', '<form id="signForm">', '<input type="hidden" value="' + Active.activeId + '" name="activeId" />', '<ul class="personal-infor-list">', "<li>", '<label class="title"><em>*</em>\u771f\u5b9e\u59d3\u540d\uff1a</label>', '<div class="personal-infor-cont">', '<input type="text" class="txt txt2" id="signName" name="signName" value="">', "</div>", "</li>", '<li style="z-index:3;">', '<label class="title"><em>*</em>\u624b\u673a\u53f7\u7801\uff1a</label>', '<div class="personal-infor-cont">', '<input type="text" class="txt txt2" id="signTele" name="signTele" value="">', "</div>", "</li>", '<li style="z-index:3;">', '<label class="title">QQ\u53f7\u7801\uff1a</label>', '<div class="personal-infor-cont">', '<input type="text" class="txt txt2" id="signQQ"  name="signQQ" value="">', "</div>", "</li>", "<li>", '<label class="title"><em>*</em>\u6027\u522b\uff1a</label>', '<div class="personal-infor-cont">', '<label><input type="radio" tabindex="2" name="sex" value="0" checked="checked">\u7537</label>', '<label><input type="radio" tabindex="3" name="sex" value="1">\u5973</label>', "</div>", "</li>", "<li>", '<label class="title"><em>*</em>\u5e74\u9f84\uff1a</label>', '<div class="personal-infor-cont">', '<input type="text" class="txt txt2" id="signAge"  name="signAge" value="">', "</div>", "</li>", "<li>", '<label class="title"><em>*</em>\u804c\u4e1a\uff1a</label>', '<div class="personal-infor-cont">', '<input type="text" class="txt txt2" id="signCarrer"  name="signCarrer" value="">', "</div>", "</li>", '<li style="z-index:2;">', '<label class="title"><em>*</em>\u5730\u5740\uff1a</label>', '<div class="personal-infor-cont">', '<div class="selectbox2 border-radius-s3" id="province">', '<span class="select-label border-radius-s3"><i class="trangle border-radius-s3"></i>\u8bf7\u9009\u62e9</span>', '<input type="hidden" value="" name="province" />', '<ul class="border-radius" style="display:none;"><li>--<li></ul>', "</div> ", '<div class="selectbox2 border-radius-s3" id="town">', '<span class="select-label border-radius-s3"><i class="trangle border-radius-s3"></i>\u8bf7\u9009\u62e9</span>', '<input type="hidden" value="" name="town" />', '<ul class="border-radius" style="display:none;"><li>--</li></ul>', "</div> ", '<div class="selectbox2 border-radius-s3" id="city">', '<span class="select-label border-radius-s3"><i class="trangle border-radius-s3"></i>\u8bf7\u9009\u62e9</span>', '<input type="hidden" value="" name="city" />', '<ul class="border-radius" style="display:none;"><li>--</li></ul>', "</div>", "<div>", '<textarea class="add-text-area border-radius-s3" name="address"></textarea>', "</div>", '<p style="color:#aaa;">\u8bf7\u586b\u5199\u6709\u6548\u63a5\u6536\u5730\u5740\uff0c\u4ee5\u4fbf\u63a5\u6536\u5956\u54c1</p>', "</div>", "</li>", '<li style="padding-left: 268px;">', '<label class="title" style="width: 268px;"><em>*</em>\u6211\u5e38\u7528\u8bfa\u57fa\u4e9a\u624b\u673a\u542c\u7684\u6b4c\u66f2\u540dor\u94c3\u58f0\u540d\uff1a</label>', '<div class="personal-infor-cont">', '<input type="text" class="txt txt2" id="signSong"  name="signSong" value="">', "</div>", "</li>", "</ul>", "</form>", '<div class="popbox-btns"><a class="btn-blue border-radius-s3" href="javascript:;">\u786e\u5b9a</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn-gray border-radius-s3" href="javascript:;">\u91cd\u7f6e</a></div>', "</div>", "</div>", "</div>", "</div>"];
    $("body").append(html.join(""));
    App.toCenter("#GsignLayer")
};
