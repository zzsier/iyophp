...
// 数据库相关 (mysql 连接时)
define('UC_DBHOST', '10.10.73.21');			// UCenter 数据库主机
define('UC_DBUSER', 'root');				// UCenter 数据库用户名
define('UC_DBPW', 'Z?zlx718625');				// UCenter 数据库密码
...
define('UC_API', 'http://127.0.0.1/ucenter/branches/1.5.0/server'); // UCenter 的 URL 地址, 在调用头像时依赖此常量
