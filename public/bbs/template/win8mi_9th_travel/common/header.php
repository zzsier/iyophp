    ...
    <div class="wp cl"> 
      ...
      <div class="userbox"> 
        ...
        <ul class="usernav user_part">
          ...
          <a href="member.php?mod={$_G[setting][regname]}" class="user_login">注册</a>
          <a href="javascript:;" onclick="showWindow('login', 'member.php?mod=logging&action=login&viewlostpw=1')" class="user_login find_back" style="margin-right: 10px;">{lang forgotpw}</a>
        </ul>
