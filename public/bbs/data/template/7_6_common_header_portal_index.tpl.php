...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1434824860, '6', './data/template/7_6_common_header_portal_index.tpl.php', './template/mobanbus_mhapp', 'common/header_portal_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1434824860, '6', './data/template/7_6_common_header_portal_index.tpl.php', './template/mobanbus_mhapp', 'common/header_portal_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1434824860, '6', './data/template/7_6_common_header_portal_index.tpl.php', './template/mobanbus_mhapp', 'common/header_portal_index')
;?>
