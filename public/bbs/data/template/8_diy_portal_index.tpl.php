...
0
|| checktplrefresh('data/diy/./template/jmxzw_20150218_business_series//portal/index.htm', './template/jmxzw_20150218_business_series/common/header.htm', 1434895090, 'diy', './data/template/8_diy_portal_index.tpl.php', 'data/diy/./template/jmxzw_20150218_business_series/', 'portal/index')
|| checktplrefresh('data/diy/./template/jmxzw_20150218_business_series//portal/index.htm', './template/jmxzw_20150218_business_series/common/xzw_sidemenu.htm', 1434895090, 'diy', './data/template/8_diy_portal_index.tpl.php', 'data/diy/./template/jmxzw_20150218_business_series/', 'portal/index')
|| checktplrefresh('data/diy/./template/jmxzw_20150218_business_series//portal/index.htm', './template/jmxzw_20150218_business_series/common/footer.htm', 1434895090, 'diy', './data/template/8_diy_portal_index.tpl.php', 'data/diy/./template/jmxzw_20150218_business_series/', 'portal/index')
|| checktplrefresh('data/diy/./template/jmxzw_20150218_business_series//portal/index.htm', './template/default/common/header_common.htm', 1434895090, 'diy', './data/template/8_diy_portal_index.tpl.php', 'data/diy/./template/jmxzw_20150218_business_series/', 'portal/index')
|| checktplrefresh('data/diy/./template/jmxzw_20150218_business_series//portal/index.htm', './template/default/common/header_qmenu.htm', 1434895090, 'diy', './data/template/8_diy_portal_index.tpl.php', 'data/diy/./template/jmxzw_20150218_business_series/', 'portal/index')
|| checktplrefresh('data/diy/./template/jmxzw_20150218_business_series//portal/index.htm', './template/jmxzw_20150218_business_series/common/xzw_top_search_simple.htm', 1434895090, 'diy', './data/template/8_diy_portal_index.tpl.php', 'data/diy/./template/jmxzw_20150218_business_series/', 'portal/index')
;
block_get('13,14,18,11,12,10,9');?>
...
<div style="clear:both;"></div>
  ...
  <ul>
        ...
        <div class="rightbox wrapper">
            <!--[diy=diy_xzw_wrapper_datas]--><div id="diy_xzw_wrapper_datas" class="area"><div id="frameBeN955" class="cl_frame_bm frame move-span cl frame-1"><div id="frameBeN955_left" class="column frame-1-c"><div id="frameBeN955_left_temp" class="move-span temp"></div><?php block_display('13');?></div></div></div><!--[/diy]--> 
        </div>
        <!-- wrapper end -->
    </div>
    ...
    <div id="J_beauty_bg_top">
        ...
        <div class="g-change-l">    
            ...
            <div class="wp xzw_index">
                    <!--[diy=diy_xzw_ad_1]--><div id="diy_xzw_ad_1" class="area"><div id="framekTWMF1" class="cl_frame_bm frame move-span cl frame-1"><div id="framekTWMF1_left" class="column frame-1-c"><div id="framekTWMF1_left_temp" class="move-span temp"></div><?php block_display('14');?></div></div></div><!--[/diy]--> 
            </div>    
            <div class="w_h J_scrollspy ">
                ...
                <!--[diy=diy_xzwgw20150211_J_hotSaleWrap_1]--><div id="diy_xzwgw20150211_J_hotSaleWrap_1" class="area"><div id="frameH827J7" class="cl_frame_bm frame move-span cl frame-1"><div id="frameH827J7_left" class="column frame-1-c"><div id="frameH827J7_left_temp" class="move-span temp"></div><?php block_display('18');?><?php block_display('11');?></div></div></div><!--[/diy]--> 
            </div>
        </div>
        <!--右侧-->
    <div class="g-fixed-r">
   ...
   <div class="parents-care-products" id="J_pcpWrap">
    ...
    <div class="reco-content-wrap">
        <div class="reco-content-inner" id="J_rcInner_0">
            <!--[diy=diy_xzwgw20150211_J_rcInner_0]--><div id="diy_xzwgw20150211_J_rcInner_0" class="area"><div id="framepiiTjG" class="cl_frame_bm frame move-span cl frame-1"><div id="framepiiTjG_left" class="column frame-1-c"><div id="framepiiTjG_left_temp" class="move-span temp"></div><?php block_display('12');?></div></div></div><!--[/diy]-->
        </div>   
    </div>
</div>
        </div>
...
-->
<div class=" ">
  		<!--[diy=diy_xzw_guide_bbs]--><div id="diy_xzw_guide_bbs" class="area"><div id="frameIq43gR" class="xfs xfs_nbd frame move-span cl frame-1"><div id="frameIq43gR_left" class="column frame-1-c"><div id="frameIq43gR_left_temp" class="move-span temp"></div><?php block_display('10');?></div></div></div><!--[/diy]--> 
    </div>
</div>
...
<div class="col_inner_ct">
  		<!--[diy=diy_ad_2]--><div id="diy_ad_2" class="area"><div id="frameyXNgz8" class="cl_frame_bm frame move-span cl frame-1"><div class="title frame-title" style='background-image:none;background-repeat:repeat;background-color:rgb(255, 255, 255);'><span class="titletext">友情链接</span></div><div id="frameyXNgz8_left" class="column frame-1-c"><div id="frameyXNgz8_left_temp" class="move-span temp"></div><?php block_display('9');?></div></div></div><!--[/diy]--> 
  	</div>
</div>
