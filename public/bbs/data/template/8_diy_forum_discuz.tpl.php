...
block_get('15,16');?><?php include template('common/header'); ?><script src="template/jmxzw_20150218_business_series/beauty_15_02_10/js/jquery-1.5.1.min.js" type="text/javascript" charset="gb2312"></script>
    ...
    <div class="indexContent" id="recommandCon">
        ...
        <div id="portal-block-258799999446" class="udiyblock" type="CommonSource">              
            <div class="recommandCon">
                <ul class="recom_img">
                   <!--[diy=diynavtop]--><div id="diynavtop" class="area"><div id="frameZQ5bGE" class="frame move-span cl frame-1"><div id="frameZQ5bGE_left" class="column frame-1-c"><div id="frameZQ5bGE_left_temp" class="move-span temp"></div><?php block_display('15');?></div></div></div><!--[/diy]-->
   </ul>

               <ul class="recom_txt">
                  <!--[diy=diy_xzw_top_bbs_textwz]--><div id="diy_xzw_top_bbs_textwz" class="area"><div id="frameIKrsRF" class="cl_frame_bm frame move-span cl frame-1"><div id="frameIKrsRF_left" class="column frame-1-c"><div id="frameIKrsRF_left_temp" class="move-span temp"></div><?php block_display('16');?></div></div></div><!--[/diy]-->
   </ul>
             </div>
        </div> 
        <!--站长推荐内容 end-->
...
<div class="wp xzw_index">
  		<!--[diy=diy_xzw_ad_001]--><div id="diy_xzw_ad_001" class="area"></div><!--[/diy]--> 
</div>
...
<!--  焦点下部 全屏横幅广告占位   -->
<div class="wp xzw_index">
  		<!--[diy=diy_xzw_ad_002]--><div id="diy_xzw_ad_002" class="area"></div><!--[/diy]--> 
</div>

<?php if(empty($gid)) { ?><?php echo adshow("text/wp a_t");?><?php } if(empty($gid)) { ?>
<div class="wp">
...
<div class="fl bm"  style="border-top:none !important;">
...
<tr><?php $favorderid = 0;?><?php if(is_array($forum_favlist)) foreach($forum_favlist as $key => $favorite) { $forum=$favforumlist[$favorite[id]];?><?php $forumurl = !empty($forum['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$forum['domain'].'.'.$_G['setting']['domain']['root']['forum'] : 'forum.php?mod=forumdisplay&fid='.$forum['fid'];?><?php if($forumcolumns>1) { if($favorderid && ($favorderid % $forumcolumns == 0)) { ?>
</tr>
...
<?php } elseif(is_array($forum['lastpost'])) { if($cat['forumcolumns'] < 3) { ?>
                                                ...
                                                <cite><?php echo $forum['lastpost']['dateline'];?> 
                                                <?php if($forum['lastpost']['author']) { ?><?php echo $forum['lastpost']['author'];?>
...
<?php } } ?>
                            ...
                            <!-- 此处 dd 添加 class="xg1" ，以使版块名称下的“今日” “主题数”等字体为浅灰色 -->
                            <!--此处控制版块标题模块属性  注释掉 "最后发表" 等多余字体-->
...
<?php } ?>
                                ...
                                <!-- 版块一列模式 --> <!-- class="xs2" 控制版块名称字体属性 ，因与文章列表页摘要部分冲突，故不加，或改成其他的。 - discuz 默认没有-->
<dl<?php if(!empty($forum['extra']['iconwidth']) && !empty($forum['icon'])) { ?> style="margin-left: <?php echo $forum['extra']['iconwidth'];?>px;"<?php } ?>>

<dt><a href="<?php echo $forumurl;?>"  <?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a> <?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="今日"> (<?php echo $forum['todayposts'];?>)</em><?php } ?></dt>

<?php if(empty($forum['redirect'])) { ?><dd ><span class="xi2">
                                        <?php echo dnumber($forum['threads']); ?> </span><span class="xg1"> / <?php echo dnumber($forum['posts']); ?> </span>
