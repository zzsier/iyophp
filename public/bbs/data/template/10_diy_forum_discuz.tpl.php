<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('discuz');?><?php include template('common/header'); ?><script src="template/jmxzw_20150218_business_series/beauty_15_02_10/js/jquery-1.5.1.min.js" type="text/javascript" charset="gb2312"></script>
