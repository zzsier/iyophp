...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1434824659, '6', './data/template/7_6_common_header_portal_portalcp.tpl.php', './template/mobanbus_mhapp', 'common/header_portal_portalcp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1434824659, '6', './data/template/7_6_common_header_portal_portalcp.tpl.php', './template/mobanbus_mhapp', 'common/header_portal_portalcp')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1434824659, '6', './data/template/7_6_common_header_portal_portalcp.tpl.php', './template/mobanbus_mhapp', 'common/header_portal_portalcp')
;?>
