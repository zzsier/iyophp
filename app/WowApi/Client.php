...
use App\WowApi\Api\ApiInterface;
use App\WowApi\Api\Achievements;
use App\WowApi\Api\Arena;
use App\WowApi\Api\Auction;
use App\WowApi\Api\Challenge;
use App\WowApi\Api\Character;
use App\WowApi\Api\Classes;
use App\WowApi\Api\Items;
use App\WowApi\Api\ItemClasses;
use App\WowApi\Api\Guild;
use App\WowApi\Api\GuildPerks;
use App\WowApi\Api\GuildRewards;
use App\WowApi\Api\Quests;
use App\WowApi\Api\Races;
use App\WowApi\Api\Realm;
use App\WowApi\Api\Recipes;
...
class Client
{
        ...
        $this->options = new ParameterBag(
            array_merge(
                array(
                    ...
                    //'region' => 'us',
                    'locale' => 'zh_CN',
                    'apikey' => 's7k5athwmb7je72bh3egqn5uyu72ymhm',
                    //'url' => ':protocol://:region.battle.net:fullPath',
                    'url' => 'https://api.battlenet.com.cn:fullPath',
     ...
     * @return void
     */
    public function setRequest(\App\WowApi\Request\RequestInterface $request)
    {
