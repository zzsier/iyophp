<div class="col-md-3 side-bar">
    ...
    <div class="panel-body text-center">
      <div class="btn-group">
        <a href="
          ...
          <i class="glyphicon glyphicon-pencil"> </i> {{ trans('message.New Topic') }}
        </a>
      </div>
    </div>
  </div>
  ...
  @if (isset($links) && count($links))
    <div class="panel panel-default corner-radius">
      <div class="panel-heading text-center">
        <h3 class="panel-title">{{ trans('message.Links') }}</h3>
      </div>
  ...
  @if (Route::currentRouteName() == 'topics.index')
      <div class="panel panel-default corner-radius">
        <div class="panel-heading text-center">
          <h3 class="panel-title">{{ trans('message.Recomended Resources') }}</h3>
        </div>
  ...
  @if (isset($nodeTopics) && count($nodeTopics))
    <div class="panel panel-default corner-radius">
      <div class="panel-heading text-center">
        <h3 class="panel-title">{{ trans('message.Same Node Topics') }}</h3>
      </div>
      <div class="panel-body">
        <ul class="list">
  ...
  <div class="panel panel-default corner-radius">
    <div class="panel-heading text-center">
      <h3 class="panel-title">{{ trans('message.Tips and Tricks') }}</h3>
    </div>
    <div class="panel-body">
      {{-- $siteTip->body --}}
    </div>
  ...
  <div class="panel panel-default corner-radius">
    <div class="panel-heading text-center">
      <h3 class="panel-title">{{ trans('message.Site Status') }}</h3>
    </div>
    <div class="panel-body">
      <ul>
        <li>{{ trans('message.Total User') }}: {{-- $siteStat->user_count --}} </li>
        <li>{{ trans('message.Total Topic') }}: {{-- $siteStat->topic_count --}} </li>
        <li>{{ trans('message.Total Reply') }}: {{-- $siteStat->reply_count --}} </li>
      </ul>
    </div>
  </div>
