...
@section('title')
{{ trans('message.Create New Topic') }}_@parent
@stop
...
<div class="topic_create">
  ...
  <div class="col-md-4 side-bar">
    ...
    <div class="panel panel-default corner-radius help-box">
      <div class="panel-heading text-center">
        <h3 class="panel-title">{{ trans('message.This kind of topic is not allowed.') }}</h3>
      </div>
      <div class="panel-body">
        <ul class="list">
    ...
    <div class="panel panel-default corner-radius help-box">
      <div class="panel-heading text-center">
        <h3 class="panel-title">{{ trans('message.We can benefit from it.') }}</h3>
      </div>
      <div class="panel-body">
        <ul class="list">
          <li>分享生活见闻, 分享知识</li>
