...
@section('title')
{{ trans('message.My Notifications') }} @parent
@stop
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
      {{ trans('message.My Notifications') }}
    </div>
                    ...
                    @if (count($notification->topic))
                        ...
                        <div class="infos">
                          ...
                          <div class="media-heading">
                            ...
                            <span class="meta">
                                 • {{ trans('message.at') }} • <span class="timeago">{{ $notification->created_at }}</span>
                            </span>
                          </div>
...
{{ $notification->body }}
                    ...
                    @else
                      <div class="deleted text-center">{{ trans('message.Data has been deleted.') }}</div>
                    @endif
                </li>
                @endforeach
            </ul>
    ...
    @else
        <div class="panel-body">
            <div class="empty-block">{{ trans('message.You dont have any notice yet!') }}</div>
        </div>
    @endif
