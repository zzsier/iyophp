...
@section('title')
{{{ $user->name }}} {{ trans('message.Basic Info') }}_@parent
@stop
...
<div class="users-show">
  ...
  <div class="main-col col-md-9 left-col">
    ...
    @if ($user->is_banned)
      <div class="text-center alert alert-info"><b>{{ trans('message.This user is banned!') }}</b></div>
    @endif
    ...
    <div class="panel panel-default">
      ...
      <ul class="nav nav-tabs user-info-nav" role="tablist">
        <li class="active"><a href="#recent_replies" role="tab" data-toggle="tab">{{ trans('message.Recent Replies') }}</a></li>
        <li><a href="#recent_topics" role="tab" data-toggle="tab">{{ trans('message.Recent Topics') }}</a></li>
      </ul>
      ...
      <div class="panel-body remove-padding-vertically remove-padding-horizontal">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="recent_replies">
            ...
            @else
              <div class="empty-block">{{ trans('message.Dont have any comment yet') }}~~</div>
            @endif
